...
namespace SFA.DAS.RoatpAssessor.Web.Services
{
    public class ClarificationSectionReviewOrchestrator : IClarificationSectionReviewOrchestrator
    {
        ...
        public async Task<ApplicationSectorsViewModel> GetSectorsViewModel(GetSectorsRequest request)
        {
            ...
            GetClarificationSectorsRequest apiRequest = new GetClarificationSectorsRequest
            {
                UserId = request.UserId
            };

            var selectedSectors = await _clarificationApiClient.GetClarificationSectors(request.ApplicationId, apiRequest);
        ...
        private async Task SetSectorReviewOutcome(GetSectorDetailsRequest request, ClarifierSectorDetailsViewModel viewModel)
        {
            ...
            GetClarificationPageReviewOutcomeRequest apiRequest = new GetClarificationPageReviewOutcomeRequest
            {
                ...
                UserId = request.PageId
            };
            var pageReviewOutcome = await _clarificationApiClient.GetClarificationPageReviewOutcome(request.ApplicationId, apiRequest);
