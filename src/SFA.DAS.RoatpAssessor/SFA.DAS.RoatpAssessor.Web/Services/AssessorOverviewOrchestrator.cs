...
namespace SFA.DAS.RoatpAssessor.Web.Services
{
    public class AssessorOverviewOrchestrator : IAssessorOverviewOrchestrator
    {
        ...
        public async Task<AssessorApplicationViewModel> GetOverviewViewModel(GetAssessorOverviewRequest request)
        {
            ...
            var apiCommand = new GetAllAssessorPageReviewOutcomesRequest { UserId = request.UserId };
            var savedOutcomes = await _assessorApiClient.GetAllAssessorPageReviewOutcomes(request.ApplicationId, apiCommand);
