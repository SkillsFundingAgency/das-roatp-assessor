    ...
    public class ClarificationControllerBase<T> : Controller where T : class
    {
                                                          ...
                                                          string errorView) where RAVM : ClarifierReviewAnswersViewModel
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                var apiCommand = BuildApiCommand(
                ...
                submittedPageOutcomeSuccessfully = await _clarificationApiClient.SubmitClarificationPageReviewOutcome(command.ApplicationId, apiCommand);
                                                    ...
                                                    string errorView) where SVM : ClarifierSectorDetailsViewModel
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                var apiCommand = BuildApiCommand(SequenceIds.DeliveringApprenticeshipTraining,
