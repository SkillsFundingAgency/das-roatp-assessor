...
public abstract class ApiClientBase<AC>
{
    ...
    protected async Task<T> Get<T>(string uri)
    {
        ...
        {
            _logger.LogError(ex, "Error when processing GET request: for {Uri}", uri);
            throw;
        }
    }
    ...
    protected async Task<HttpStatusCode> Post<T>(string uri, T model)
    {
        ...
        {
            _logger.LogError(ex, "Error when processing POST request for {Uri}", uri);
            throw;
        }
    }
    ...
    protected async Task<HttpStatusCode> Put<T>(string uri, T model)
    {
        ...
        {
            _logger.LogError(ex, "Error when processing PUT request for {Uri}", uri);
            throw;
        }
    }
    ...
    protected async Task<HttpStatusCode> Delete(string uri)
    {
        ...
        {
            _logger.LogError(ex, "Error when processing DELETE request for {Uri}", uri);
            throw;
        }
    }
