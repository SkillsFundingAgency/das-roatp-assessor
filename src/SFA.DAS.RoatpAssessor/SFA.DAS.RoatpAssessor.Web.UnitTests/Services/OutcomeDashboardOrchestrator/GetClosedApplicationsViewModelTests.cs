...
namespace SFA.DAS.RoatpAssessor.Web.UnitTests.Services.OutcomeDashboardOrchestrator
{
    ...
    public class GetClosedApplicationsViewModelTests
    {
        ...
        public async Task When_getting_closed_applications_the_applications__are_returned()
        {
            ...
            {
                new ClosedApplicationSummary { ApplicationReferenceNumber = "sdjfs", ProviderRoute = "Main", OrganisationName = "Org 1", Ukprn = "132436565", ApplicationId = Guid.NewGuid(), OutcomeStatus = ModerationStatus.Pass, OutcomeDate = DateTime.UtcNow },
                new ClosedApplicationSummary { ApplicationReferenceNumber = "fghhgfj", ProviderRoute = "Supporting", OrganisationName = "Org 2", Ukprn = "3465904568", ApplicationId = Guid.NewGuid(), OutcomeStatus = ModerationStatus.Fail, OutcomeDate = DateTime.UtcNow  }
            };
