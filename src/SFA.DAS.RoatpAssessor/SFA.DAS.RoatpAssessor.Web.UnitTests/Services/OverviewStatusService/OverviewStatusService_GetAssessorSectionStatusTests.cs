...
{
    [TestFixture]
    public class OverviewStatusService_GetAssessorSectionStatusTests
    {
        ...
        {
            _outcomes.Add(new AssessorPageReviewOutcome { SequenceNumber = _sequenceNumber + 1, SectionNumber = _sectionNumber });
            _outcomes.Add(new AssessorPageReviewOutcome { SequenceNumber = _sequenceNumber + 2, SectionNumber = _sectionNumber });
        ...
        {
            _outcomes.Add(new AssessorPageReviewOutcome { SequenceNumber = _sequenceNumber, SectionNumber = _sectionNumber + 1 });
            _outcomes.Add(new AssessorPageReviewOutcome { SequenceNumber = _sequenceNumber, SectionNumber = _sectionNumber + 2 });
        ...
        [TestCase(null, null)]
        [TestCase(AssessorPageReviewStatus.Pass, AssessorPageReviewStatus.Pass)]
        [TestCase(AssessorPageReviewStatus.Fail, AssessorPageReviewStatus.Fail)]
        [TestCase(AssessorPageReviewStatus.InProgress, AssessorPageReviewStatus.InProgress)]
        public void When_Single_Outcome_Returns_Expected_Status(string pageReviewStatus, string expectedStatus)
        {
            _outcomes.Add(new AssessorPageReviewOutcome { SequenceNumber = _sequenceNumber, SectionNumber = _sectionNumber, Status = pageReviewStatus });
        ...
        {
            _outcomes.Add(new AssessorPageReviewOutcome { SequenceNumber = _sequenceNumber, SectionNumber = _sectionNumber, Status = string.Empty });
            _outcomes.Add(new AssessorPageReviewOutcome { SequenceNumber = _sequenceNumber, SectionNumber = _sectionNumber, Status = string.Empty });
            _outcomes.Add(new AssessorPageReviewOutcome { SequenceNumber = _sequenceNumber, SectionNumber = _sectionNumber, Status = string.Empty });
        ...
        {
            _outcomes.Add(new AssessorPageReviewOutcome { SequenceNumber = _sequenceNumber, SectionNumber = _sectionNumber, Status = AssessorPageReviewStatus.Pass });
            _outcomes.Add(new AssessorPageReviewOutcome { SequenceNumber = _sequenceNumber, SectionNumber = _sectionNumber, Status = AssessorPageReviewStatus.Pass });
            _outcomes.Add(new AssessorPageReviewOutcome { SequenceNumber = _sequenceNumber, SectionNumber = _sectionNumber, Status = AssessorPageReviewStatus.Pass });
        ...
        public void When_Several_Matching_Outcomes_And_All_Pass_Or_Fail_Returns_Expected_Status(int passOutcomes, int failOutcomes, bool isSectorsSection, string expectedStatus)
        {
            ...
            {
                _outcomes.Add(new AssessorPageReviewOutcome { SequenceNumber = _sequenceNumber, SectionNumber = _sectionNumber, Status = AssessorPageReviewStatus.Fail });
            }
        ...
        public void When_Several_Matching_Outcomes_And_Some_Are_Not_Set_Returns_InProgress(int passOutcomes, int failOutcomes, int notSetOutcomes)
        {
            ...
            {
                _outcomes.Add(new AssessorPageReviewOutcome { SequenceNumber = _sequenceNumber, SectionNumber = _sectionNumber, Status = null });
            }
        ...
        public void When_Several_Matching_Outcomes_And_Some_Are_InProgress_Returns_InProgress(int passOutcomes, int failOutcomes, int inProgressOutcomes)
        {
            ...
            {
                _outcomes.Add(new AssessorPageReviewOutcome { SequenceNumber = _sequenceNumber, SectionNumber = _sectionNumber, Status = AssessorPageReviewStatus.InProgress });
            }
