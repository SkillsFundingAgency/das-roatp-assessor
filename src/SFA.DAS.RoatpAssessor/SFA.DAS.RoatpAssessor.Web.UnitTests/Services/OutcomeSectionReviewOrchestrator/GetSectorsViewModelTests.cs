...
namespace SFA.DAS.RoatpAssessor.Web.UnitTests.Services.OutcomeSectionReviewOrchestrator
{
    ...
    public class GetSectorsViewModelTests
    {
        ...
        public void SetUp()
        {
            ...
            _orchestrator = new Web.Services.OutcomeSectionReviewOrchestrator(logger.Object, _applicationApiClient.Object, _moderationApiClient.Object, _clarificationApiClient.Object, supplementaryInformationService.Object);
        }
