...
namespace SFA.DAS.RoatpAssessor.Web.UnitTests.Services.AssessorDashboardOrchestrator
{
    ...
    public class GetInProgressApplicationsViewModelTests
    {
        ...
        public async Task When_getting_in_progress_applications_then_the_application_summary_is_returned()
        {
            ...
            var response = await _orchestrator.GetInProgressApplicationsViewModel(userId, null, null, null);
        ...
        public async Task When_getting_in_progress_applications_the_applications_for_the_user_are_returned()
        {
            ...
            {
                new AssessorApplicationSummary { ApplicationReferenceNumber = "sdjfs", Assessor1Name = "sdjfghdfgd", ProviderRoute = "Main", OrganisationName = "Org 1", Ukprn = "132436565", ApplicationId = Guid.NewGuid(), Assessor1UserId = "flggfdg" },
            ...
            _applicationApiClient.Setup(x => x.GetInProgressApplications(userId, null, null, null)).ReturnsAsync(applications);
