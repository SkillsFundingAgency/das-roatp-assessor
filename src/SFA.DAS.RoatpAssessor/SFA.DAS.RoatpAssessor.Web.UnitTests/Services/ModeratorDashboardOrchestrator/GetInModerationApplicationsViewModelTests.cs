...
namespace SFA.DAS.RoatpAssessor.Web.UnitTests.Services.ModeratorDashboardOrchestrator
{
    ...
    public class GetInModerationApplicationsViewModelTests
    {
        ...
        public void SetUp()
        {
            ...
            _applicationApiClient.Setup(x => x.GetInModerationApplications(_user.UserId(), null, null, null)).ReturnsAsync(new List<ModerationApplicationSummary>());
        ...
        public async Task When_getting_in_moderation_applications_then_the_application_summary_is_returned()
        {
            ...
            var response = await _orchestrator.GetInModerationApplicationsViewModel(userId, null, null, null);
        ...
        public async Task When_getting_in_moderation_applications_the_applications__are_returned()
        {
            ...
            _applicationApiClient.Setup(x => x.GetInModerationApplications(userId, null, null, null)).ReturnsAsync(applications);
